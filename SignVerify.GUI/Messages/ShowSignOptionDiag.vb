...
Public Class NoCardDetailsMessageDiag
    'Ctor
    ...
    Private Sub InitControlsStrings()
        ...
        'Set Form text
        Me.Text = My.Resources.ControlStrings.NoCardDetailsForm

        'Set label
        Me.lblMessage.Text = My.Resources.ControlStrings.NoCardDetailsMessage
